...
const createCustomShadow = (color: string) => {
  ...
  const info = palette.info as SimplePaletteColorOptions;
  const success = palette.success as SimplePaletteColorOptions;
  const warning = palette.warning as SimplePaletteColorOptions;
